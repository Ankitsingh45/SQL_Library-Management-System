...
CREATE TABLE issued_status (
    ...
    issued_member_id VARCHAR(10), -- Matches members.member_id
    issued_book_name VARCHAR(80),
    issued_date DATE,
    issued_book_isbn VARCHAR(50), -- Matches books.isbn
    issued_emp_id VARCHAR(10), -- Matches employees.emp_id
...
--insert values in issued_status table
...
--insert values in return_status table-
...
SELECT
    b.category,
    SUM(b.rental_price) as Totalsum,
    COUNT(*)
FROM books as b
JOIN
...
SELECT TOP 3
    e.emp_name,
    b.branch_name,  -- Ensure 'branch_name' exists in 'branch' table
